...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "odoo.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: _t("Eagle ERP Session Expired"), data: {message: _t("Your Eagle ERP session expired. Please refresh the current web page.")}});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("Eagle ERP Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("Eagle ERP Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("Eagle ERP Warning"),
            buttons: [
